...
export default createCloudflareHandler({ routes, shell });`)}
      ...
      <p>
        The server renders HTML. Links swap fragments into a slot without a full
        reload. Interactive pieces are Custom Elements with Shadow DOM. Nothing
        in that chain needs a bundler or a client framework runtime.
      </p>
