...
class NativeFragmentsHeader extends HTMLElement {
  ...
  sync() {
    const links = [
      { href: "https://docs.nativefragments.org", label: "Docs", active: true },
      { href: "https://nativefragments.org/examples", label: "Examples" },
      { href: "https://nativefragments.org/demos", label: "Demos" },
      { href: "https://nativefragments.org/manifesto", label: "Manifesto" },
    ];
