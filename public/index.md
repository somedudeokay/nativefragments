...
Native Fragments builds Cloudflare Worker apps with server-rendered HTML, fragment navigation, and native Shadow DOM components. It has no build step by default and keeps application code close to the Web Platform.
